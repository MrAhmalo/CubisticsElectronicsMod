...
public class LowElectricElementsIngotItem extends Item {
	public LowElectricElementsIngotItem() {
		...
		setRegistryName("low_electric_elements_ingot");
	}
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Ingot with low electric level."));
	}
}
